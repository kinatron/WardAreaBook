module InPlaceMacrosHelper
  ...
  def mySimple_format(text)
    # remove the <p> tags that are messing up the highlighting
    simple_format(text)[3..-5]
  end
  ...
  def in_place_editor_field(object, method, tag_options = {}, in_place_editor_options = {})
    ...
    tag = content_tag(tag_options.delete(:tag), mySimple_format(instance_tag.value(instance_tag.object)),tag_options)
